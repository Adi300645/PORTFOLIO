                ...
                >
                    <div className={`flex items-center justify-start mt-6`}>
                        ...
                        >
                            ...
                            <div className="absolute w-48 h-48 -left-32 -top-0 blur-[100px] rounded-full bg-white bg-gradient-to-bl from-blue-900 to-blue-50 animate-pulse -z-20">
                                {" "}
                            </div>
                            <div className="absolute w-48 h-48 -right-0 -bottom-0 blur-[100px] rounded-full bg-white bg-gradient-to-bl from-teal-700 to-blue-50 -z-20 opacity-50">
                                {" "}
                            </div>
                            <form>
                                <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-transparent z-0 dark:border-gray-600 relative shadow-2xl">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className="absolute w-28 h-28 right-0 bottom-0 my-auto mx-auto blur-[100px] bg-white bg-gradient-to-bl to-yellow-50 -z-20">
                        {" "}
                    </div>
                    <div className="absolute w-48 h-48 -left-32 -top-0 blur-[100px] rounded-full bg-white bg-gradient-to-bl from-blue-900 to-blue-50 animate-pulse -z-20">
                        {" "}
                    </div>
                    <div className="absolute w-48 h-48 -right-0 -top-0 blur-[100px] rounded-full bg-white bg-gradient-to-bl from-teal-700 to-blue-50 -z-20 opacity-50">
                        {" "}
                    </div>
                    <form>
